...
--
-- Host: db:3306
-- Generation Time: Dec 22, 2023 at 01:07 PM
...
CREATE TABLE `users` (
  ...
  `address` varchar(255) COLLATE utf8mb3_czech_ci DEFAULT NULL,
  `zip` varchar(255) COLLATE utf8mb3_czech_ci DEFAULT NULL,
  `city` varchar(255) COLLATE utf8mb3_czech_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_czech_ci;
